...
exports.IMX_JWT_KEY_URL = exports.environment = void 0;
const sdk_1 = require("@imtbl/sdk");
require("dotenv").config();
// Ternary operator to set environment based on .env value
exports.environment = process.env.ENVIRONMENT === "PRODUCTION" ? sdk_1.config.Environment.PRODUCTION : sdk_1.config.Environment.SANDBOX;
//Used for verification of the Passport JWTs
exports.IMX_JWT_KEY_URL = "https://auth.immutable.com/.well-known/jwks.json?_gl=1*1g7a0qs*_ga*NDg1NTg3MDI3LjE2ODU1OTY1Mzg.*_ga_4JBHZ7F06X*MTY4ODUyNjkyNy4xNC4wLjE2ODg1MjY5MjcuMC4wLjA.*_ga_7XM4Y7T8YC*MTY4ODUyNjkyNy4yNy4wLjE2ODg1MjY5MjcuMC4wLjA.";
const serverConfig = {
    [sdk_1.config.Environment.SANDBOX]: {
        ...
        mintRequestURL: (chainName, collectionAddress, referenceId) => `https://api.sandbox.immutable.com/v1/chains/${chainName}/collections/${collectionAddress}/nfts/mint-requests/${referenceId}`,
        ...
        metadata: {
            ...
            description: "ok I need PRICE TO GO UP. like VERY SOON. I cant take this anymore. every day I am checking price and it is staying the same. every day, check price, same price. I cant take this anymore, I have over invested, by a lot. it is what it is. but I need the price to GO UP ALREADY. can devs DO SOMETHING??",
            image: "https://emerald-variable-swallow-254.mypinata.cloud/ipfs/QmNYn1DS9djwCLCcu7Pyrb6uUtGzf29AH6cBcXAncELeik/1.png",
            attributes: [],
        },
    },
    [sdk_1.config.Environment.PRODUCTION]: {
        ...
        mintRequestURL: (chainName, collectionAddress, referenceId) => `https://api.immutable.com/v1/chains/${chainName}/collections/${collectionAddress}/nfts/mint-requests/${referenceId}`,
        enableWebhookVerification: true, //Should the server verify the webhook SNS messages?
